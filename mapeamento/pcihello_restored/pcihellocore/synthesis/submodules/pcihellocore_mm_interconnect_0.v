...
module pcihellocore_mm_interconnect_0 (
	...
	wire   [31:0] switcher_s1_agent_m0_address;                                           // switcher_s1_agent:m0_address -> switcher_s1_translator:uav_address
	...
	wire  [115:0] switcher_s1_agent_rf_source_data;                                       // switcher_s1_agent:rf_source_data -> switcher_s1_agent_rsp_fifo:in_data
	...
	wire  [115:0] switcher_s1_agent_rsp_fifo_out_data;                                    // switcher_s1_agent_rsp_fifo:out_data -> switcher_s1_agent:rf_sink_data
	...
	wire  [115:0] buttons_s1_agent_rf_source_data;                                        // buttons_s1_agent:rf_source_data -> buttons_s1_agent_rsp_fifo:in_data
	...
	wire  [115:0] buttons_s1_agent_rsp_fifo_out_data;                                     // buttons_s1_agent_rsp_fifo:out_data -> buttons_s1_agent:rf_sink_data
	...
	wire  [114:0] switcher_s1_agent_rp_data;                                              // switcher_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [114:0] buttons_s1_agent_rp_data;                                               // buttons_s1_agent:rp_data -> router_006:sink_data
	...
	wire          led_green_s1_agent_rp_valid;                                            // led_green_s1_agent:rp_valid -> router_007:sink_valid
	wire  [114:0] led_green_s1_agent_rp_data;                                             // led_green_s1_agent:rp_data -> router_007:sink_data
	wire          led_green_s1_agent_rp_ready;                                            // router_007:sink_ready -> led_green_s1_agent:rp_ready
	wire          led_green_s1_agent_rp_startofpacket;                                    // led_green_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          led_green_s1_agent_rp_endofpacket;                                      // led_green_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	wire          led_red_s1_agent_rp_valid;                                              // led_red_s1_agent:rp_valid -> router_008:sink_valid
	wire  [114:0] led_red_s1_agent_rp_data;                                               // led_red_s1_agent:rp_data -> router_008:sink_data
	wire          led_red_s1_agent_rp_ready;                                              // router_008:sink_ready -> led_red_s1_agent:rp_ready
	wire          led_red_s1_agent_rp_startofpacket;                                      // led_red_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          led_red_s1_agent_rp_endofpacket;                                        // led_red_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          switcher_s1_burst_adapter_source0_valid;                                // switcher_s1_burst_adapter:source0_valid -> switcher_s1_agent:cp_valid
	wire  [114:0] switcher_s1_burst_adapter_source0_data;                                 // switcher_s1_burst_adapter:source0_data -> switcher_s1_agent:cp_data
	wire          switcher_s1_burst_adapter_source0_ready;                                // switcher_s1_agent:cp_ready -> switcher_s1_burst_adapter:source0_ready
	wire    [8:0] switcher_s1_burst_adapter_source0_channel;                              // switcher_s1_burst_adapter:source0_channel -> switcher_s1_agent:cp_channel
	wire          switcher_s1_burst_adapter_source0_startofpacket;                        // switcher_s1_burst_adapter:source0_startofpacket -> switcher_s1_agent:cp_startofpacket
	wire          switcher_s1_burst_adapter_source0_endofpacket;                          // switcher_s1_burst_adapter:source0_endofpacket -> switcher_s1_agent:cp_endofpacket
	wire          buttons_s1_burst_adapter_source0_valid;                                 // buttons_s1_burst_adapter:source0_valid -> buttons_s1_agent:cp_valid
	wire  [114:0] buttons_s1_burst_adapter_source0_data;                                  // buttons_s1_burst_adapter:source0_data -> buttons_s1_agent:cp_data
	...
	wire          router_005_src_valid;                                                   // router_005:src_valid -> switcher_s1_rsp_width_adapter:in_valid
	wire  [114:0] router_005_src_data;                                                    // router_005:src_data -> switcher_s1_rsp_width_adapter:in_data
	wire          router_005_src_ready;                                                   // switcher_s1_rsp_width_adapter:in_ready -> router_005:src_ready
	wire    [8:0] router_005_src_channel;                                                 // router_005:src_channel -> switcher_s1_rsp_width_adapter:in_channel
	wire          router_005_src_startofpacket;                                           // router_005:src_startofpacket -> switcher_s1_rsp_width_adapter:in_startofpacket
	wire          router_005_src_endofpacket;                                             // router_005:src_endofpacket -> switcher_s1_rsp_width_adapter:in_endofpacket
	wire          switcher_s1_rsp_width_adapter_src_valid;                                // switcher_s1_rsp_width_adapter:out_valid -> rsp_demux_004:sink_valid
	wire  [150:0] switcher_s1_rsp_width_adapter_src_data;                                 // switcher_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          switcher_s1_rsp_width_adapter_src_ready;                                // rsp_demux_004:sink_ready -> switcher_s1_rsp_width_adapter:out_ready
	wire    [8:0] switcher_s1_rsp_width_adapter_src_channel;                              // switcher_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	wire          switcher_s1_rsp_width_adapter_src_startofpacket;                        // switcher_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_004:sink_startofpacket
	wire          switcher_s1_rsp_width_adapter_src_endofpacket;                          // switcher_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_004:sink_endofpacket
	wire          router_006_src_valid;                                                   // router_006:src_valid -> buttons_s1_rsp_width_adapter:in_valid
	wire  [114:0] router_006_src_data;                                                    // router_006:src_data -> buttons_s1_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                   // buttons_s1_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [8:0] router_006_src_channel;                                                 // router_006:src_channel -> buttons_s1_rsp_width_adapter:in_channel
	...
	wire  [150:0] buttons_s1_rsp_width_adapter_src_data;                                  // buttons_s1_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	wire          buttons_s1_rsp_width_adapter_src_ready;                                 // rsp_demux_005:sink_ready -> buttons_s1_rsp_width_adapter:out_ready
	wire    [8:0] buttons_s1_rsp_width_adapter_src_channel;                               // buttons_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	...
	wire          router_007_src_valid;                                                   // router_007:src_valid -> led_green_s1_rsp_width_adapter:in_valid
	wire  [114:0] router_007_src_data;                                                    // router_007:src_data -> led_green_s1_rsp_width_adapter:in_data
	wire          router_007_src_ready;                                                   // led_green_s1_rsp_width_adapter:in_ready -> router_007:src_ready
	wire    [8:0] router_007_src_channel;                                                 // router_007:src_channel -> led_green_s1_rsp_width_adapter:in_channel
	wire          router_007_src_startofpacket;                                           // router_007:src_startofpacket -> led_green_s1_rsp_width_adapter:in_startofpacket
	wire          router_007_src_endofpacket;                                             // router_007:src_endofpacket -> led_green_s1_rsp_width_adapter:in_endofpacket
	wire          led_green_s1_rsp_width_adapter_src_valid;                               // led_green_s1_rsp_width_adapter:out_valid -> rsp_demux_006:sink_valid
	wire  [150:0] led_green_s1_rsp_width_adapter_src_data;                                // led_green_s1_rsp_width_adapter:out_data -> rsp_demux_006:sink_data
	wire          led_green_s1_rsp_width_adapter_src_ready;                               // rsp_demux_006:sink_ready -> led_green_s1_rsp_width_adapter:out_ready
	wire    [8:0] led_green_s1_rsp_width_adapter_src_channel;                             // led_green_s1_rsp_width_adapter:out_channel -> rsp_demux_006:sink_channel
	wire          led_green_s1_rsp_width_adapter_src_startofpacket;                       // led_green_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_006:sink_startofpacket
	wire          led_green_s1_rsp_width_adapter_src_endofpacket;                         // led_green_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_006:sink_endofpacket
	wire          router_008_src_valid;                                                   // router_008:src_valid -> led_red_s1_rsp_width_adapter:in_valid
	wire  [114:0] router_008_src_data;                                                    // router_008:src_data -> led_red_s1_rsp_width_adapter:in_data
	wire          router_008_src_ready;                                                   // led_red_s1_rsp_width_adapter:in_ready -> router_008:src_ready
	wire    [8:0] router_008_src_channel;                                                 // router_008:src_channel -> led_red_s1_rsp_width_adapter:in_channel
	wire          router_008_src_startofpacket;                                           // router_008:src_startofpacket -> led_red_s1_rsp_width_adapter:in_startofpacket
	wire          router_008_src_endofpacket;                                             // router_008:src_endofpacket -> led_red_s1_rsp_width_adapter:in_endofpacket
	wire          led_red_s1_rsp_width_adapter_src_valid;                                 // led_red_s1_rsp_width_adapter:out_valid -> rsp_demux_007:sink_valid
	wire  [150:0] led_red_s1_rsp_width_adapter_src_data;                                  // led_red_s1_rsp_width_adapter:out_data -> rsp_demux_007:sink_data
	wire          led_red_s1_rsp_width_adapter_src_ready;                                 // rsp_demux_007:sink_ready -> led_red_s1_rsp_width_adapter:out_ready
	wire    [8:0] led_red_s1_rsp_width_adapter_src_channel;                               // led_red_s1_rsp_width_adapter:out_channel -> rsp_demux_007:sink_channel
	wire          led_red_s1_rsp_width_adapter_src_startofpacket;                         // led_red_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_007:sink_startofpacket
	wire          led_red_s1_rsp_width_adapter_src_endofpacket;                           // led_red_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_007:sink_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                                  // cmd_mux_004:src_valid -> switcher_s1_cmd_width_adapter:in_valid
	wire  [150:0] cmd_mux_004_src_data;                                                   // cmd_mux_004:src_data -> switcher_s1_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                  // switcher_s1_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire    [8:0] cmd_mux_004_src_channel;                                                // cmd_mux_004:src_channel -> switcher_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_004_src_startofpacket;                                          // cmd_mux_004:src_startofpacket -> switcher_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                            // cmd_mux_004:src_endofpacket -> switcher_s1_cmd_width_adapter:in_endofpacket
	wire          switcher_s1_cmd_width_adapter_src_valid;                                // switcher_s1_cmd_width_adapter:out_valid -> switcher_s1_burst_adapter:sink0_valid
	wire  [114:0] switcher_s1_cmd_width_adapter_src_data;                                 // switcher_s1_cmd_width_adapter:out_data -> switcher_s1_burst_adapter:sink0_data
	wire          switcher_s1_cmd_width_adapter_src_ready;                                // switcher_s1_burst_adapter:sink0_ready -> switcher_s1_cmd_width_adapter:out_ready
	wire    [8:0] switcher_s1_cmd_width_adapter_src_channel;                              // switcher_s1_cmd_width_adapter:out_channel -> switcher_s1_burst_adapter:sink0_channel
	wire          switcher_s1_cmd_width_adapter_src_startofpacket;                        // switcher_s1_cmd_width_adapter:out_startofpacket -> switcher_s1_burst_adapter:sink0_startofpacket
	wire          switcher_s1_cmd_width_adapter_src_endofpacket;                          // switcher_s1_cmd_width_adapter:out_endofpacket -> switcher_s1_burst_adapter:sink0_endofpacket
	wire          cmd_mux_005_src_valid;                                                  // cmd_mux_005:src_valid -> buttons_s1_cmd_width_adapter:in_valid
	wire  [150:0] cmd_mux_005_src_data;                                                   // cmd_mux_005:src_data -> buttons_s1_cmd_width_adapter:in_data
	wire          cmd_mux_005_src_ready;                                                  // buttons_s1_cmd_width_adapter:in_ready -> cmd_mux_005:src_ready
	wire    [8:0] cmd_mux_005_src_channel;                                                // cmd_mux_005:src_channel -> buttons_s1_cmd_width_adapter:in_channel
	...
	wire  [114:0] buttons_s1_cmd_width_adapter_src_data;                                  // buttons_s1_cmd_width_adapter:out_data -> buttons_s1_burst_adapter:sink0_data
	wire          buttons_s1_cmd_width_adapter_src_ready;                                 // buttons_s1_burst_adapter:sink0_ready -> buttons_s1_cmd_width_adapter:out_ready
	wire    [8:0] buttons_s1_cmd_width_adapter_src_channel;                               // buttons_s1_cmd_width_adapter:out_channel -> buttons_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_006_src_valid;                                                  // cmd_mux_006:src_valid -> led_green_s1_cmd_width_adapter:in_valid
	wire  [150:0] cmd_mux_006_src_data;                                                   // cmd_mux_006:src_data -> led_green_s1_cmd_width_adapter:in_data
	wire          cmd_mux_006_src_ready;                                                  // led_green_s1_cmd_width_adapter:in_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                // cmd_mux_006:src_channel -> led_green_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_006_src_startofpacket;                                          // cmd_mux_006:src_startofpacket -> led_green_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                            // cmd_mux_006:src_endofpacket -> led_green_s1_cmd_width_adapter:in_endofpacket
	...
	wire          cmd_mux_007_src_valid;                                                  // cmd_mux_007:src_valid -> led_red_s1_cmd_width_adapter:in_valid
	wire  [150:0] cmd_mux_007_src_data;                                                   // cmd_mux_007:src_data -> led_red_s1_cmd_width_adapter:in_data
	wire          cmd_mux_007_src_ready;                                                  // led_red_s1_cmd_width_adapter:in_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                // cmd_mux_007:src_channel -> led_red_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_007_src_startofpacket;                                          // cmd_mux_007:src_startofpacket -> led_red_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                            // cmd_mux_007:src_endofpacket -> led_red_s1_cmd_width_adapter:in_endofpacket
	...
	wire          switcher_s1_agent_rdata_fifo_src_valid;                                 // switcher_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] switcher_s1_agent_rdata_fifo_src_data;                                  // switcher_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          switcher_s1_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_004:in_0_ready -> switcher_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                      // avalon_st_adapter_004:out_0_valid -> switcher_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                       // avalon_st_adapter_004:out_0_data -> switcher_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                      // switcher_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                      // avalon_st_adapter_004:out_0_error -> switcher_s1_agent:rdata_fifo_sink_error
	...
	wire          led_green_s1_agent_rdata_fifo_src_valid;                                // led_green_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] led_green_s1_agent_rdata_fifo_src_data;                                 // led_green_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          led_green_s1_agent_rdata_fifo_src_ready;                                // avalon_st_adapter_006:in_0_ready -> led_green_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                      // avalon_st_adapter_006:out_0_valid -> led_green_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                       // avalon_st_adapter_006:out_0_data -> led_green_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                      // led_green_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                      // avalon_st_adapter_006:out_0_error -> led_green_s1_agent:rdata_fifo_sink_error
	wire          led_red_s1_agent_rdata_fifo_src_valid;                                  // led_red_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] led_red_s1_agent_rdata_fifo_src_data;                                   // led_red_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          led_red_s1_agent_rdata_fifo_src_ready;                                  // avalon_st_adapter_007:in_0_ready -> led_red_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                      // avalon_st_adapter_007:out_0_valid -> led_red_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                       // avalon_st_adapter_007:out_0_data -> led_red_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                      // led_red_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                      // avalon_st_adapter_007:out_0_error -> led_red_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (switcher_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (switcher_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (switcher_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (switcher_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (switcher_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (switcher_s1_burst_adapter_source0_channel),       //                .channel
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (1),
		.ADAPTER_VERSION           ("13.1")
	) switcher_s1_burst_adapter (
		.clk                   (pcie_hard_ip_0_pcie_core_clk_clk),                //       cr0.clk
		.reset                 (inport_reset_reset_bridge_in_reset_reset),        // cr0_reset.reset
		.sink0_valid           (switcher_s1_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (switcher_s1_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (switcher_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (switcher_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (switcher_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (switcher_s1_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (switcher_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (switcher_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (switcher_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (switcher_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (switcher_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (switcher_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	pcihellocore_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (pcie_hard_ip_0_pcie_core_clk_clk),                //       clk.clk
		.reset              (inport_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
		.sink_ready         (switcher_s1_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (switcher_s1_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (switcher_s1_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (switcher_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (switcher_s1_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (switcher_s1_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (switcher_s1_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (switcher_s1_rsp_width_adapter_src_data),          //          .data
		.out_channel          (switcher_s1_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (switcher_s1_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (switcher_s1_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (switcher_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                           // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (switcher_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (switcher_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (switcher_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (switcher_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (switcher_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (switcher_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                           // (terminated)
	);
